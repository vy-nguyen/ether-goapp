...
const (
	clientIdentifier = "tudo-geth" // Client identifier to advertise over the network
)
...
func init() {
	...
	app.Flags = append(app.Flags, verbosityFlag)
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	ks := stack.AccountManager().Backends(keystore.KeyStoreType)[0].(kstore.KsInterface)
